      ...
      <Router>
        ...
        {/* NY Times Api */}
         <Routes>
            ...
            <Route exact path="/automobiles" element={<News setProgress={setProgress} apiKey={apiKey} key='automobiles' pageSize={pageSize} category='automobiles' badgeColor='primary' />} />
